...
//'Fido is a Jack Russell that loves chicken and their tennis ball!'
...
//CODE HERE
  let phone1 = new Phone('Samsung', 'Galaxy',3,'black', true )
  
  let phone2 = new Phone('iPhone', 'S10', 8,'black', false )
  
  let phone3 = new Phone('Nextel', 'A10', 2 , 'black', false )
